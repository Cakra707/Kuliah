...
main()
{
   cout << "Masukan Jumlah Uang    : "; 
    ...
    cout << "Pecahan Rp500        = " << limaRatusRp << " keping" <<endl;
    cout << "Pecahan Rp200        = " << duaRatusRp << " keping" <<endl;
    cout << "Pecahan Rp100        = " << seratusRp << " keping" <<endl;
    
    cout << "\nTotal jumlah lembaran  = " << seratusRb + limaPuluhRb + duaPuluhRb + sepuluhRb + limaRb + duaRb + satuRb << " Lembar" <<endl;
    cout << "Total jumlah koin      = " << limaRatusRp + duaRatusRp + seratusRp << " keping" <<endl;
